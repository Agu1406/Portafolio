package GradoSuperiorDAW.TerceraEvaluacion.UT7ObjetosAvanzados.Ejercicio2UT7ClaseRectangulo2Avance;
 ...
 * de los métodos creados en la clase {@link MPAAEjercicio2UT7}.
 *
 * @author Agu1406 (Agustín)
 * @see MPAAEjercicio2UT7
 * @since 08/03/2024
 */
public class MainRectangulo {
    public static void main(String[] args) {
        ...
        MPAAEjercicio2UT7 nuevoRectangulo1 = new MPAAEjercicio2UT7(nombrePersonalizado, x1, x2, y1, y2);

        // Creación de un par de estancias ingresando los datos directamente en el código.
        MPAAEjercicio2UT7 nuevoRectangulo2 = new MPAAEjercicio2UT7("experimento2", 0, 25, 0, 25);
        MPAAEjercicio2UT7 nuevoRectangulo3 = new MPAAEjercicio2UT7("experimento3", 30, 55, 0, 25);
