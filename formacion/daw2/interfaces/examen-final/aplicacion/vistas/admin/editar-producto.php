...
<div class="container mt-4">
    ...
    <form action="<?php echo $GLOBALS['configuracion']['rutaBase']; ?>/publico/admin/productos/actualizar" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <?php if ($producto['imagen_principal']): ?>
                <div class="mb-2">
                    <img src="<?php echo $GLOBALS['configuracion']['rutaBase']; ?>/publico/<?php echo $producto['imagen_principal']; ?>" alt="<?php echo htmlspecialchars($producto['nombre']); ?>" style="max-width: 200px;">
                </div>
            <?php endif; ?>
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="destacado" name="destacado" value="1" <?php echo $producto['destacado'] ? 'checked' : ''; ?>>
            <label class="form-check-label" for="destacado">Producto destacado</label>
        </div>
        
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="activo" name="activo" value="1" <?php echo $producto['activo'] ? 'checked' : ''; ?>>
